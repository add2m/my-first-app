...
# قائمة الفيديوهات مع تحويلها لروابط تشغيل مباشرة
video_ids = [
...
if current_page == "booking":
    ...
    for vid in video_ids:
        # رابط التشغيل المباشر من جوجل درايف
        direct_url = f"https://drive.google.com/uc?export=download&id={vid}"
        st.video(direct_url)
        st.write("---")
    ...
    # أزرار شفافة تفتح في تابات جديدة
